...
const RightSidebar = (props) => {
    const { cartItems, addToCart, clearCart, removeFromCart, getTotalPrice, cleanCash, addCash, cash, change, submit } = props;
          ...
          <div className="select-none h-auto w-full text-center pt-3 pb-4 px-4">
            ...
            <div className="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
              <div className="flex text-lg font-semibold">
                ...
                <button onClick={() => cleanCash()} className="bg-red-500 text-white rounded-lg shadow hover:shadow-lg focus:outline-none inline-block px-2 py-1 text-sm mr-3"> <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                  </svg>{/* <span>LIMPIAR</span> */}</button>
            ...
            <div className="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
              <div className="flex text-lg font-semibold">
                <div className="flex-grow text-left">TARJETA</div>
                <div className="flex text-right">
                  <div className="mr-2">$</div>
                  <input type="number" className="w-28 text-right bg-white shadow rounded-lg focus:bg-white focus:shadow-lg px-2 focus:outline-none appearance-none" />
                </div>
              </div>
            </div>
            <div className={"flex mb-3 text-lg font-semibold text-blue-gray-700 rounded-lg py-2 px-3 "+( change >= 0 ? "bg-cyan-50" : "bg-pink-100")}>
              {change >= 0 && <div className="text-cyan-800">CAMBIO</div> }
